...
### Python
    ...
    try:
        result = client.models.generate_content(
            model="gemini-3.6-flash", contents=[myfile, "Describe this file."]
        )
        print(result)
...
### Go
    ...
    _, err = client.Models.GenerateContent(ctx, "gemini-3.6-flash", contents, nil)
...
### Python
    ...
    result = client.models.generate_content(
        model="gemini-3.6-flash", contents=[myfile, "Describe this audio clip"]
    )
    print(f"{result.text=}")
